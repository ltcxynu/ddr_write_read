...
HD_PWD='E:/project_fpga/ddr_write_read/ddr_write_read.runs/axi_ddr_mpsoc_PL_DDR_v1_0_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_ddr_mpsoc_PL_DDR_v1_0_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_ddr_mpsoc_PL_DDR_v1_0_0_0.tcl
