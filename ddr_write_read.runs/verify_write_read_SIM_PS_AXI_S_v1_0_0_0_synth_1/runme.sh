...
HD_PWD='E:/project_fpga/ddr_write_read/ddr_write_read.runs/verify_write_read_SIM_PS_AXI_S_v1_0_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log verify_write_read_SIM_PS_AXI_S_v1_0_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source verify_write_read_SIM_PS_AXI_S_v1_0_0_0.tcl
