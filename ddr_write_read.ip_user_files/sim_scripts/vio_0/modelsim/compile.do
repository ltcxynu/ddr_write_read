...
vlog -work xpm  -incr -mfcu -sv -L axi_vip_v1_1_11 -L zynq_ultra_ps_e_vip_v1_0_11 -L xilinx_vip "+incdir+../../../../ddr_write_read.gen/sources_1/ip/vio_0/hdl/verilog" "+incdir+../../../../ddr_write_read.gen/sources_1/ip/vio_0/hdl" "+incdir+D:/xilinx/Vivado/2021.2/data/xilinx_vip/include" \
...
vlog -work xil_defaultlib  -incr -mfcu "+incdir+../../../../ddr_write_read.gen/sources_1/ip/vio_0/hdl/verilog" "+incdir+../../../../ddr_write_read.gen/sources_1/ip/vio_0/hdl" "+incdir+D:/xilinx/Vivado/2021.2/data/xilinx_vip/include" \
