...
//--------------------------------------------------------------------------------
//Command: generate_target bd_2c0a.bd
//Design : bd_2c0a
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_2c0a,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_2c0a,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "axi_ddr_mpsoc_system_ila_0_0.hwdef" *) 
module bd_2c0a
   (SLOT_0_AXI_araddr,
    SLOT_0_AXI_arburst,
    SLOT_0_AXI_arcache,
    ...
    probe5,
    resetn);
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI ARADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_0_AXI, ADDR_WIDTH 32, ARUSER_WIDTH 1, AWUSER_WIDTH 1, BUSER_WIDTH 1, CLK_DOMAIN axi_ddr_mpsoc_axi_m_aclk_300M, DATA_WIDTH 128, FREQ_HZ 100000000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 1, INSERT_VIP 0, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 2, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 2, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 1, SUPPORTS_NARROW_BURST 1, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 1" *) input [31:0]SLOT_0_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI ARUSER" *) input [0:0]SLOT_0_AXI_aruser;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI AWUSER" *) input [0:0]SLOT_0_AXI_awuser;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI BUSER" *) input [0:0]SLOT_0_AXI_buser;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI RUSER" *) input [0:0]SLOT_0_AXI_ruser;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI WUSER" *) input [0:0]SLOT_0_AXI_wuser;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI WVALID" *) input SLOT_0_AXI_wvalid;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN axi_ddr_mpsoc_axi_m_aclk_300M, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk;
  input [0:0]probe0;
  input [0:0]probe1;
  input [1023:0]probe2;
  input [0:0]probe3;
  ...
  wire [0:0]net_slot_0_axi_aruser;
  ...
  wire [0:0]net_slot_0_axi_awuser;
  ...
  wire [0:0]net_slot_0_axi_wuser;
  wire net_slot_0_axi_wvalid;
  wire [0:0]probe0_1;
  wire [0:0]probe1_1;
  wire [1023:0]probe2_1;
  wire [0:0]probe3_1;
  wire [1023:0]probe4_1;
  wire [0:0]probe5_1;
  wire resetn_1;
  ...
  assign Conn_ARUSER = SLOT_0_AXI_aruser[0];
  ...
  assign Conn_AWUSER = SLOT_0_AXI_awuser[0];
  ...
  assign Conn_BUSER = SLOT_0_AXI_buser[0];
  ...
  assign Conn_RUSER = SLOT_0_AXI_ruser[0];
  ...
  assign Conn_WUSER = SLOT_0_AXI_wuser[0];
  assign Conn_WVALID = SLOT_0_AXI_wvalid;
  assign clk_1 = clk;
  assign probe0_1 = probe0[0];
  assign probe1_1 = probe1[0];
  assign probe2_1 = probe2[1023:0];
  assign probe3_1 = probe3[0];
  assign probe4_1 = probe4[1023:0];
  assign probe5_1 = probe5[0];
  assign resetn_1 = resetn;
  bd_2c0a_g_inst_0 g_inst
       (.aclk(clk_1),
        .aresetn(resetn_1),
        ...
        .m_slot_0_axi_buser(net_slot_0_axi_buser),
  ...
  bd_2c0a_ila_lib_0 ila_lib
       (.clk(clk_1),
        .probe0(probe0_1),
        .probe1(probe1_1),
        .probe10(net_slot_0_axi_arid),
        .probe11(net_slot_0_axi_arlen),
        .probe12(net_slot_0_axi_arlock),
        .probe13(net_slot_0_axi_arprot),
        .probe14(net_slot_0_axi_arqos),
        .probe15(net_slot_0_axi_arsize),
        .probe16(net_slot_0_axi_aruser),
